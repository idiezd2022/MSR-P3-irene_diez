...
def generate_launch_description():
    ...
    pkg_share_folder = get_package_share_directory("lykos_description")
        ...
        [
            generate_load_controller_launch_description(
                ...
                controller_params_file=join(
                    pkg_share_folder, 'config', 'lykos_controllers.yaml'))
        ],
    )

    # Load robot controller
    lykos_controller = GroupAction(
        [
            generate_load_controller_launch_description(
    ...
    arm_pkg_share_folder = get_package_share_directory("lykos_moveit_config")
    ...
    ld.add_action(lykos_controller)
