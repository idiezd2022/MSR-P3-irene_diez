...
def generate_launch_description():
    moveit_config = MoveItConfigsBuilder("lykos", package_name="lykos_moveit_config").to_moveit_configs()
    ...
    pkg_path = get_package_share_directory('lykos_description')
    ...
    model_path = get_model_paths(['lykos_description'])

    lykos_description_launcher = IncludeLaunchDescription(
       PathJoinSubstitution(
           [FindPackageShare("lykos_moveit_config"), "launch", "rsp.launch.py"]
           #[FindPackageShare("lykos_description"), "launch", "lykos_state_publisher.launch.py"]
       ),
    )
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare("lykos_description"), "rviz", "robot.rviz"]
    )
    ...
    ld.add_action(lykos_description_launcher)
